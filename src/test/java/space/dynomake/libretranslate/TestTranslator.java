 ...
 * Taken from https://github.com/igniterealtime/Spark/blob/cb972ae18cfd56b1814d929341c797827f73dfd9/plugins/translator/src/test/java/com/jivesoftware/spark/translator/TestTranslator.java
 */
public class TestTranslator {

    public static void main(String[] args) {
        Translator.setUrlApi("https://translate.fedilab.app/translate");
        ...
        while (again) {
            ...
            String result = Translator.translate(type, text);
